                                             ...
                                             ProposalFunc proposal)
{
    ...
    * @param  gen       - Generator for random number generation. An instance of
    *                     std::default_random_engine
    * @param  potential - Function passed for potential calculation
    * @param  proposal  - Function for proposing the next move in the MCMC simulations.
    *
    ...
    */
    ...
    {        
        ...
        // Calculate energy
        std::vector<double> Es{potential({s0, s1}, V_params)};
...
bool ReplicaExchangeAcceptance(StateVec E, 
                               StateVec beta, 
                               std::default_random_engine& gen)
{
    /**
     * @brief   Metropolis criterion for exchanging two replicas in the ladder.
     * 
     * @param   E    - Contains the energies of the two replicas to be exchanged
     * @param   beta - Contains the 1/kT values for the two replicas
     * @param   gen  - Instance of std::default_random_engine for random number 
     *                 generation.
     * 
     * @result         true for accept exchange, false otherwise.
     */
    double p_acc = std::min(1.0, std::exp(-(beta[0] - beta[1]) * (E[0] - E[1])));
